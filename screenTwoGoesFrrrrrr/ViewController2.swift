...
class ViewController2: UIViewController {
    ...
    let noAccount = UILabel()
        noAccount.text = "Already have an account?"
    ...
    let loginTo: UILabel = {
    let loginTo = UILabel()
        loginTo.text = "Create your new account"
    ...
    lazy var rePasswordInput: UITextField = {
    let usernameInput = UITextField()
        usernameInput.text = "Re-type password"
        usernameInput.backgroundColor = .gray
        usernameInput.layer.cornerRadius = 8
    return usernameInput
    }()
...
override func viewDidLoad() {
    ...
    rePasswordInput.snp.makeConstraints { make in
        make.centerX.equalToSuperview()
